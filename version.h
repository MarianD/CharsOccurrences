...
namespace AutoVersion{
	...
	static const long BUILDS_COUNT  = 1321;
	#define RC_FILEVERSION 1,6,5,337
	#define RC_FILEVERSION_STRING "1, 6, 5, 337\0"
	static const char FULLVERSION_STRING [] = "1.6.5.337";
